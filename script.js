...
const wishList = [
  {
    text: "chúc m và gia đình một mùa trung thu thật vui vẻ, tràn ngập niềm vui và hạnh phúc",
    img: "./assets/1.jpg",
  },
  {
    text: "chúc cho mọi nguyện ước của m đêm nay sẽ trở thành hiện thực-)",
    img: "./assets/2.jpg",
  },
  {
    text: "m đừng quên tặng quà t nha:))",
    img: "./assets/3.jpg",
  },
  {
